...
- `kroki-sandbox` — uses a pi-fence-managed local Kroki service with `placement: "sandbox"`; the runtime can be the existing single `yuzutech/kroki` container or the fixed `docker/kroki/compose.yaml` stack, both bound to `127.0.0.1:8000`.
