...
- Binding dictionaries and legacy processor-id alias lookup are hardened against prototype-pollution keys such as `__proto__`; resolver lookups only use own, validated binding entries.
