...
- `/fence list`, `/fence doctor`, and binding logs now report placement selector diagnostics, including disabled placements, no matching processor in the selected placement, and ambiguous placement matches.
