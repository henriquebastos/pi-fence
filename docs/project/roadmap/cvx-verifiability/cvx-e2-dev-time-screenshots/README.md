...
| [S2](cvx-e2-s2-multi-scenario-gallery/README.md) | **Multi-scenario rendering with a per-run HTML gallery; variants plumbing ready for future theme/width matrices** | 🛠️ Planned |
