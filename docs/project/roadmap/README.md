...
| Code | Story | Status |
|------|-------|--------|
| [CV0.E1.S0](cv0-it-works/cv0-e1-kroki-through-the-wire/cv0-e1-s0-testing-foundation/README.md) | **Testing foundation: I can run unit, contract, extension, and live tests from a clean clone** | 🛠️ Planned |
