...
| [CVx.E2.S2](cvx-verifiability/cvx-e2-dev-time-screenshots/cvx-e2-s2-multi-scenario-gallery/README.md) | **Multi-scenario rendering with a per-run HTML gallery; variants plumbing ready for future theme/width matrices** | 🛠️ Planned |
