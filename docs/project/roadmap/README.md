...
| [CV8 — Internal Quality](cv8--internal-quality/README.md) | `simplification` | Not started | Simplify internals that accumulated duplication or unnecessary indirection during feature delivery. |
