...
| CV | Type | State | Goal |
|----|------|-------|------|
| [CV0 — It Works](cv0--it-works/README.md) | `legibility` | Not done | The extension renders diagrams inline with a zero-config happy path. |
| [CV1 — Take Control](cv1--take-control/README.md) | `control` | Not done | The user owns the registry through configuration, diagnosis, and the error feedback loop. |
