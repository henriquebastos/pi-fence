...
| Code | Story | Status |
|------|-------|--------|
| [S1](cv0-e2-s1-local-graphviz/README.md) | **I use local graphviz when I want privacy and offline** | Planned |
| `S2` | **I bind a tag to a specific processor in settings** | Planned |
