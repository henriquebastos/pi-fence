...
# Plan: CV0.E1.S2 — Other Kroki-supported diagrams

**Story:** [README.md](README.md)
**Epic:** [CV0.E1 — Kroki Through The Wire](../README.md)
**Depends on:** [CV0.E1.S1 — Mermaid via Kroki](../cv0-e1-s1-mermaid-via-kroki/README.md)
**Date:** 2026-04-18
...
| 5 | close | worklog + Epic/story README status flips | `wip(agent): close CV0.E1.S2` |
...
3. Manual test from [test-guide.md](test-guide.md).
...
- Status flip in the roadmap, Epic, and story READMEs.
...
**See also:** [Test Guide](test-guide.md) · [S2 README](README.md) · [S1 plan](../cv0-e1-s1-mermaid-via-kroki/plan.md) · [Principles — Testing](../../../../../product/principles.md#testing)
