...
| Code | Story | Status |
|------|-------|--------|
| [S1](cv11-e1-s1--package-runtime-assets.md) | **Package runtime assets resolve from npm installs** | Ready |
| [S2](cv11-e1-s2--kroki-endpoint-normalization.md) | **Kroki endpoint config is normalized and diagnosed** | Ready |
