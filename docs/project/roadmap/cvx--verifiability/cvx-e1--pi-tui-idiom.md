...
| Code | Story | Status |
|------|-------|--------|
| [S1](cvx-e1-s1--virtual-terminal-tests.md) | **Extension and renderer tests assert on real pi-tui output via `VirtualTerminal`** | ✅ Done |
...
**Done criterion (Epic-level):** this Epic is done when every Story listed below is done.
