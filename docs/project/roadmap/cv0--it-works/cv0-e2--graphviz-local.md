...
| Code | Story | Status |
|------|-------|--------|
| [S1](cv0-e2-s1--local-graphviz.md) | **I use local graphviz when I want privacy and offline** | ✅ Done |
| [S2](cv0-e2-s2--tag-binding.md) | **I bind a tag to a specific processor in settings** | ✅ Done |
...
- Local mermaid via `mmdc` — [CV2 — Work Offline](../cv2--work-offline/README.md).
