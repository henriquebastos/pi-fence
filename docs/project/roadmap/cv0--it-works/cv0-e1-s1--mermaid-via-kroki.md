# CV0.E1.S1 — Mermaid via Kroki

**Status:** Done

**Epic:** [CV0.E1 — Kroki Through The Wire](cv0-e1--kroki-through-the-wire.md)
**Depends on:** [CV0.E1.S0 — Testing foundation](cv0-e1-s0--testing-foundation.md)
**Date:** 2026-04-18
...
3. Run the manual test from [Verification](#verification) end to end.
